import { getInstitution, getInstitutionSubtab, saveInstitution, removeSavedInstitution } from './api.js';
...
async function initInstitutionPage() {
  ...
  let id = params.get('id') || '00000000-0000-4000-8000-000000000001';
      ...
      <div class="absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div class="flex items-center gap-4">
          <div class="w-20 h-20 rounded-2xl bg-white border-2 border-slate-700 overflow-hidden shadow-2xl flex-shrink-0 p-1">
            <img src="${currentInst.logo_url || 'https://images.unsplash.com/photo-1592280771190-3e2e4d571952?w=160'}" alt="Logo" class="w-full h-full object-cover rounded-xl">
          </div>
          <div>
